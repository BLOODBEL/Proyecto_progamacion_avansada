...
namespace APIProyecto
{
    ...
    public partial class ProyectoPAEntities : DbContext
    {
        ...
        public virtual int ActualizarFactura(Nullable<long> idFactura, Nullable<System.DateTime> fecha, Nullable<decimal> total, Nullable<decimal> precio, Nullable<long> idSuscripcion)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ActualizarFactura", idFacturaParameter, fechaParameter, totalParameter, precioParameter, idSuscripcionParameter);
        }
        ...
        public virtual int RegistrarFactura(Nullable<System.DateTime> fecha, Nullable<decimal> total, Nullable<decimal> precio, Nullable<long> idSuscripcion)
        {
            var fechaParameter = fecha.HasValue ?
                new ObjectParameter("Fecha", fecha) :
                new ObjectParameter("Fecha", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("RegistrarFactura", fechaParameter, totalParameter, precioParameter, idSuscripcionParameter);
        }
